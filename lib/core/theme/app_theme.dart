    ...
    return ThemeData(
      ...
      textTheme: TextTheme(
        ...
        titleSmall: GoogleFonts.oswald(
            fontWeight: FontWeight.w500, color: AppColors.neutral),
        bodyLarge: GoogleFonts.inter(
            fontWeight: FontWeight.normal, color: AppColors.neutral100),
        bodyMedium: GoogleFonts.inter(
            fontWeight: FontWeight.normal, color: AppColors.neutral100),
        bodySmall: GoogleFonts.inter(
            fontWeight: FontWeight.normal, color: AppColors.neutral400),
      ...
      elevatedButtonTheme: ElevatedButtonThemeData(
        style: ElevatedButton.styleFrom(
          ...
          textStyle: GoogleFonts.oswald(
              fontWeight: FontWeight.bold, letterSpacing: 1.0, fontSize: 18),
